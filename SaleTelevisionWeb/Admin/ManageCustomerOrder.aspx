<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCustomerOrder.aspx.cs" Inherits="SaleTelevisionWeb.Admin.ManageCustomerCart" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" Width="100%" DataKeyNames="Id" CssClass="table text-nowrap" BorderStyle="None" AllowPaging="true" PageSize="10">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Customer">
                                    <ItemTemplate>
                                        <asp:Label CssClass="form-label" ID="lbCustomer" runat="server" Text='<%# Eval("Customer") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Television">
                                    <ItemTemplate>
                                        <asp:Label CssClass="form-label" ID="lbTelevision" runat="server" Text='<%# Eval("Television") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtTotal" runat="server" Text='<%# Eval("Total") %>' CssClass="form-control" TextMode="Number"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                </asp:TemplateField>
