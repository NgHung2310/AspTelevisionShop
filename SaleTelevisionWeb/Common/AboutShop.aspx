<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutShop.aspx.cs" Inherits="SaleTelevisionWeb.Common.AboutShop" %>
...
<head runat="server">
    <title id="title" runat="server">About Shop</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <section class="py-5">
            <div class="container py-4">
                <header class="mb-5">
                    <h2 class="text-uppercase lined mb-4">About Shop</h2>
                    <p class="lead">No job is hard if one’s will is enduring; Even digging down the Mountain, or filling up the Ocean is done by one’s will Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                </header>
                <div class="row gy-4">
                    <div class="col-lg-8">
                            ...
                            <div class="accordion-item mb-2">
                                ...
                                <div class="accordion-collapse collapse show" id="aboutAccordion-collapseOne" aria-labelledby="aboutAccordion-collapseOne" data-bs-parent="#aboutAccordion">
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <img class="img-fluid" src="../Image/avt.jpg" alt="..."/></div>
                                            <div class="col-md-8">
                    ...
                    <div class="col-lg-4">
                        <div class="ratio ratio-4x3">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sRUoOA21ZFI" title="MONO - Em Là (Album 22 - Track No.03)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="true"></iframe>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper-container customers-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide h-auto">
                            <img class="img-fluid img-grayscale d-block mx-auto" src="../Image/avt.jpg" alt="..." width="140"></div>
                        <div class="swiper-slide h-auto">
                            <img class="img-fluid img-grayscale d-block mx-auto" src="../Image/avt.jpg" alt="..." width="140"></div>
                        <div class="swiper-slide h-auto">
                            <img class="img-fluid img-grayscale d-block mx-auto" src="../Image/avt.jpg" alt="..." width="140"></div>
